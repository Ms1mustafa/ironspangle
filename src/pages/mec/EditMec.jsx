...
export default function EditMec() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("MEC updated successfully:", inputs);
      // Optionally, you can navigate to another page or show a success message
    } catch (error) {
      console.error("Error updating MEC:", error);
      // Handle error or display message
    }
  };
  ...
  return (
    <form className="form w-full p-10 max-w-lg" onSubmit={handleSubmit}>
      <h1 className="text-3xl text-gray-600 font-bold mb-10">Edit MEC</h1>
